...
def resnet18(num_classes=10, use_batchnorm=True):
    return ResNet(BasicBlock, [2,2,2,2], use_batchnorm=use_batchnorm, num_classes=num_classes)

def resnet34(use_batchnorm=True, num_classes=10):
    return ResNet(BasicBlock, [3,4,6,3], use_batchnorm=use_batchnorm, num_classes=num_classes)

def resnet50(use_batchnorm=True, num_classes=10):
    return ResNet(Bottleneck, [3,4,6,3], use_batchnorm=use_batchnorm, num_classes=num_classes)
