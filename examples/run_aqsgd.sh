...
python pytorch_imagenet_resnet50.py --quantization-bits 4 --batch-size 64 --epochs 90 --train-dir ~/Datasets/imagenet/train \
 --val-dir ~/Datasets/imagenet/val --checkpoint-format "checkpoints/imagenet/baseline_rn18/checkpoint-{epoch}.pth.tar" 2>&1 | tee imagenet/rn18_baseline
