...
#define MPI_QUANTIZED_MAXMIN "MPI_QUANTIZED_MAXMIN"
#define MPI_QUANTIZED_QUANTIZATION "MPI_QUANTIZED_QUANTIZATION"
#define MPI_QUANTIZED_DEQUANTIZATION "MPI_QUANTIZED_DEQUANTIZATION"
#define MPI_QUANTIZED_SUM "MPI_QUANTIZED_SUM"
