...
class _CrossBarrier(_DistributedOptimizer):
    ...
    def _make_hook(self, p):
        def hook(*ignore):
            ...
            self._logger.debug("{} starts backward {}.".format(self._desc, self._get_parameter_name(p)))
    ...
    def _allreduce_grad_async(self, p):
        ...
        handle = allreduce_async_(tensor_compressed, op=Average, name="Gradient."+name)
