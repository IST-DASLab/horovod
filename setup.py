    ...
    if have_mpi:
        ...
        if grad_compression:
            ...
            SOURCES += ['horovod/common/ops/compressed/compression/cuda/cuda_functions.cu.cc',
                        ...
                        'horovod/common/ops/compressed/reducers/mpi_allgather.cc',
                        'horovod/common/ops/compressed/reducers/mpi_scatter_allgather.cc',
                        'horovod/common/ops/compressed/reducers/mpi_ring.cc',
